...
const fetchBusinessProfile = useCallback(async () => {
  ...
  //KPI computation with percentages ie(convert each invoices to inr before summarising)
   const kpis = useMemo(() => {
 ...
 return (
   <div className={dashboardStyles.pageContainer}>
     ...
     {/* ===== mainGrid now wraps BOTH the left sidebar column AND the right content column ===== */}
     <div className={dashboardStyles.mainGrid}>
       {/* LEFT COLUMN: Quick Stats + Quick Actions, stacked */}
       <div className={dashboardStyles.sidebarColumn}>
         ...
         {/**Quick Actions - now INSIDE sidebarColumn, stacked below Quick Stats */}
           ...
           <div className="p-6">
             ...
             <div className={dashboardStyles.quickActionsContainer}>
               <button
                 ...
                 className={dashboardStyles.quickActionButton}
               >
                 <div
       ...
       {/* RIGHT COLUMN: Recent Invoices table - now INSIDE mainGrid, sibling of sidebarColumn */}
