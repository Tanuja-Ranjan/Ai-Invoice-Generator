...
//this fetch the image coming from or server side
...
const BusinessProfile = () => {
  ...
  //fetch user profile is saved previously
  useEffect(() => {
    let mounted = true;
  ...
  //we can remove the preview file by this function if we want to change it or remove it
