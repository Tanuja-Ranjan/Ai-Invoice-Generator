...
} //it will return image coming from server side
...
//computes total for subtotal , tax and total
...
export default function CreateInvoice() {
  ...
  //update the item qty and descusing index
    ...
    try {
      ...
      const endpoint =
        isEditing && invoice.id
          ? `${API_BASE}/api/invoice/${invoice.id}` //put and update
          : `${API_BASE}/api/invoice`; //create invoice
